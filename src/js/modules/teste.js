    ...
    async analisarPartidaComIA(dados) {
        if (!this.ngrokDisponivel) {
            ...
            if (!teste.conectado) {
                return {
                    sucesso: false,
                    tipo: 'NGROK_INDISPONIVEL',
                    erro: teste.erro || 'Ngrok não está disponível'
                };
            }
        }
...
class WildRiftAnalyzer {
    ...
    async init() {
        try {
            ...
            if (ngrokUrlSalva && ngrokUrlSalva !== 'terisa-ciliolate-parthenogenetically.ngrok-free.dev') {
    ...
    salvarConfiguracaoNgrok() {
        ...
        if (!novaUrl || novaUrl === 'https://seu-subdominio.ngrok.app') {
        ...
        try {
            ...
            this.mostrarFeedback('URL inválida. Use o formato: https://seu-subdominio.ngrok.app', 'erro');
        }
    }
